            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-slate-100 pb-4 dark:border-zinc-800">
                ...
                <div className="flex gap-2">
                  <div className="rounded-xl border border-slate-200 bg-slate-50/50 px-3 py-1.5 text-center dark:border-zinc-800 dark:bg-zinc-950/20">
                    ...
                    <span className={`inline-block font-bold text-xs uppercase tracking-wide ${driverData.status === 'active' ? 'text-emerald-500' : 'text-rose-500'}`}>
                      {driverData.status}
                    </span>
                  </div>
                  <div className="rounded-xl border border-slate-200 bg-slate-50/50 px-3 py-1.5 text-center dark:border-zinc-800 dark:bg-zinc-950/20">
              ...
              <div>
                ...
                <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 text-xs">
                  ...
                  <div className={`col-span-2 sm:col-span-1 rounded-xl border p-4 ${isReimbursable ? 'border-emerald-200 bg-emerald-50/30 text-emerald-800 dark:border-emerald-900/40 dark:bg-emerald-950/10 dark:text-emerald-400' : 'border-rose-200 bg-rose-50/30 text-rose-800 dark:border-rose-900/40 dark:bg-rose-950/10 dark:text-rose-400'}`}>
